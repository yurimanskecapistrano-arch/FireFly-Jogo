/* FireFly canvas MVP: renderer, camera, player, creatures, capture, fishing, particles, UI and audio-ready hooks. */
const canvas=document.querySelector('#game'),ctx=canvas.getContext('2d');
const W=1280,H=720,keys=new Set();
const state={map:'village',coins:25,day:1,time:0,player:{x:300,y:510,vx:0,face:1,mode:'idle',action:0},items:{},caught:0};
const camera={x:0,target:0,shake:0};
